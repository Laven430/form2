    ...
    public function run(): void
    {
        $products = [
            ...
            [
                'name' => 'オレンジ',
                'price' => 850,
                'description' => '当店では酸味と甘味のバランスが抜群のネーブルオレンジを使用しています。酸味は控えめで、甘さと濃厚な果汁が魅力の商品です。もぎたてフルーツのスムージをお召し上がりください！',
                'seasons' => '冬',
            ...
            [
                ...
                'seasons' => '夏',
                'image_path' => 'products/watermelon.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
            ...
            [
                ...
                'seasons' => '夏,秋',
                'image_path' => 'products/muscat.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
